...
exports.GroupByLandSizeResolver = void 0;
...
let GroupByLandSizeResolver = class GroupByLandSizeResolver {
...
], GroupByLandSizeResolver.prototype, "groupByLandSize", null);
GroupByLandSizeResolver = (0, tslib_1.__decorate)([
    TypeGraphQL.Resolver(_of => LandSize_1.LandSize)
], GroupByLandSizeResolver);
exports.GroupByLandSizeResolver = GroupByLandSizeResolver;
